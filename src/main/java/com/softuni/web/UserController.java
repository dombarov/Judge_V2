...
public class UserController {
    ...
    public String loginConfirm(@Valid @ModelAttribute UserLoginBindingModel userLoginBindingModel,
        ...
        UserServiceModel user = userService.findUserByUsernameAndPasword(userLoginBindingModel.getUsername(),
    ...
    public String registerConfirm(@Valid @ModelAttribute UserRegisterBindingModel userRegisterBindingModel,
        ...
        if (bindingResult.hasErrors() || !userRegisterBindingModel.getPassword().equals(userRegisterBindingModel.getConfirmPasword())) {
